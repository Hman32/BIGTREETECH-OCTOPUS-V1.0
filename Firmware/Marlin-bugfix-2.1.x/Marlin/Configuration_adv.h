...
//#define SENSORLESS_BACKOFF_MM  { 2, 2, 0 }    //EMH // (linear=mm, rotational=°) Backoff from endstops before sensorless homing
...
#define HOMING_BACKOFF_POST_MM { 0, 0, 0 }    //EMH // (linear=mm, rotational=°) Backoff from endstops after homing
...
#define DISABLE_INACTIVE_Z false  //EMH // Set 'false' if the nozzle could fall onto your printed part!
...
#define BABYSTEPPING
  ...
  //#define BABYSTEP_WITHOUT_HOMING //EMH
 ...
 */
  ...
  #if AXIS_IS_TMC(Z2)
    #define Z2_CURRENT      850 //EMH (1500Ma * 0.9)/1.414 => max 954 (new geared z so lower to 850)
