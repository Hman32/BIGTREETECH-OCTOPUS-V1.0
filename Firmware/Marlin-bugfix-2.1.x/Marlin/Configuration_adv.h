 ...
 */
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  20   //EMH       // (seconds)
 ...
 */
#define FAN_KICKSTART_TIME  100  //EMH (ms)
#define FAN_KICKSTART_POWER 180  //EMH 64-255
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN //EMH
#define E1_AUTO_FAN_PIN FAN2_PIN //EMH
...
#define EXTRUDER_AUTO_FAN_TEMPERATURE 40 //EMH
...
#define HOMING_BUMP_MM      { 5, 5, 2 }       //EMH (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 8, 8, 8 }       //EMH Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 3, 0, 0 }    //EMH (linear=mm, rotational=°) Backoff from endstops after homing
 ...
 */
#define Z_STEPPER_AUTO_ALIGN //EMH
   ...
   */
  #define Z_STEPPER_ALIGN_XY { {  50, 165 }, { 280,  165 } } //EMH
 ...
 */
#define ASSISTED_TRAMMING  //EMH
#if ENABLED(ASSISTED_TRAMMING)

  // Define from 3 to 9 points to probe.
  #define TRAMMING_POINT_XY { {  52, 52 }, { 165,  52 }, { 278,  52 }, { 278, 278 }, { 165, 278 }, { 52, 278 } }  //EMH

  // Define position names for probe points.
  #define TRAMMING_POINT_NAME_1 "Front-Left"   //EMH
  #define TRAMMING_POINT_NAME_2 "Front-Middle" //EMH
  #define TRAMMING_POINT_NAME_3 "Front-Right"  //EMH
  #define TRAMMING_POINT_NAME_4 "Back-Right"   //EMH
  #define TRAMMING_POINT_NAME_5 "Back-Middle"  //EMH
  #define TRAMMING_POINT_NAME_6 "Back-Left"    //EMH

  #define RESTORE_LEVELING_AFTER_G35    // Enable to restore leveling setup after operation
  //#define REPORT_TRAMMING_MM          // Report Z deviation (mm) for each point relative to the first

  #define ASSISTED_TRAMMING_WIZARD      //EMH Add a Tramming Wizard to the LCD menu
...
//#define DISABLE_IDLE_Z    //EMH Disable if the nozzle could fall onto your printed part!
...
//#define MICROSTEP_MODES { 16, 16, 16, 16, 16, 16 } // [1,2,4,8,16] //EMH
 ...
 */
  ...
  #define PROBE_OFFSET_WIZARD //EMH
  ...
  #define MANUAL_MOVE_DISTANCE_MM           100, 50, 10, 1.0, 0.1  // (mm) //EMH
  ...
  #define SHOW_BOOTSCREEN                 // Show the Marlin bootscreen on startup. ** ENABLE FOR PRODUCTION **
    ...
    #define BOOTSCREEN_TIMEOUT 3000       // (ms) Total Duration to display the boot screen(s)
      ...
      #define SHOW_CUSTOM_BOOTSCREEN    //EMH Show the bitmap in Marlin/_Bootscreen.h on startup.
    #endif
  #endif

  #if HAS_MARLINUI_U8GLIB
    #define CUSTOM_STATUS_SCREEN_IMAGE  //EMH Show the bitmap in Marlin/_Statusscreen.h on the status screen.
  #endif

  #define SOUND_MENU_ITEM     //EMH Add a mute option to the LCD menu
  ...
  #define LCD_DECIMAL_SMALL_XY //EMH
   ...
   */
  #define LED_CONTROL_MENU //EMH
  #if ENABLED(LED_CONTROL_MENU)
    #define LED_COLOR_PRESETS                 // Enable the Preset Color menu option
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
    #if ENABLED(LED_COLOR_PRESETS)
      #define LED_USER_PRESET_RED          0  //EMH // User defined RED value
      #define LED_USER_PRESET_GREEN       58  //EMH // User defined GREEN value
      #define LED_USER_PRESET_BLUE       113  //EMH // User defined BLUE value
      #define LED_USER_PRESET_WHITE      255  // User defined WHITE value
      #define LED_USER_PRESET_BRIGHTNESS 255  // User defined intensity
      #define LED_USER_PRESET_STARTUP         //EMH // Have the printer display the user preset color on startup
    #endif
...
#define SET_PROGRESS_MANUALLY //EMH
#if ENABLED(SET_PROGRESS_MANUALLY)
  #define SET_PROGRESS_PERCENT            //EMH Add 'P' parameter to set percentage done
  #define SET_REMAINING_TIME              //EMH Add 'R' parameter to set remaining time
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_REMAINING_TIME             //EMH Display estimated time to completion (prefix 'R')
  ...
  #define SD_FINISHED_RELEASECOMMAND "M84XYE"  //EMH Use "M84XYE" to keep Z enabled so your bed stays in place
  ...
  #define LONG_FILENAME_HOST_SUPPORT      //EMH Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES           //EMH Scroll long filenames in the SD card menu
  ...
  #define AUTO_REPORT_SD_STATUS           //EMH Auto-report media status with 'M27 S<seconds>'
   ...
   */
  #define SDCARD_CONNECTION LCD  //EMH
 ...
 */
  ...
  #define STATUS_HEAT_POWER           //EMH Show heater output power as a vertical bar
 ...
 */
#define BABYSTEPPING                        //EMH
#if ENABLED(BABYSTEPPING)
  //#define EP_BABYSTEPPING                 // M293/M294 babystepping with EMERGENCY_PARSER support
  //#define BABYSTEP_WITHOUT_HOMING
  #define BABYSTEP_ALWAYS_AVAILABLE         //EMH  Allow babystepping at all times (not just during movement)
  //#define BABYSTEP_XY                     // Also enable X/Y Babystepping. Not supported on DELTA!
  //#define BABYSTEP_INVERT_Z               //EMH Enable if Z babysteps should go the other way
  #define BABYSTEP_MILLIMETER_UNITS         //EMH Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps
  #define BABYSTEP_MULTIPLICATOR_Z  0.01    //EMH (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY 0.01    //EMH (steps or mm) Steps or millimeter distance for each XY babystep

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    //EMH Double-click on the Status Screen for Z Babystepping.
  ...
  #define BABYSTEP_DISPLAY_TOTAL            //EMH Display total babysteps since last G28

  #define BABYSTEP_ZPROBE_OFFSET            //EMH Combine M851 Z and Babystepping
...
#define BEZIER_CURVE_SUPPORT          //EMH Requires ~2666 bytes
...
#elif HAS_MEDIA
  #define BLOCK_BUFFER_SIZE 64 //EMH
#else
  #define BLOCK_BUFFER_SIZE 64 //EMH
#endif
...
#define TX_BUFFER_SIZE 128 //EMH

// Host Receive Buffer Size
// Without XON/XOFF flow control (see SERIAL_XON_XOFF below) 32 bytes should be enough.
// To use flow control, set this buffer size to at least 1024 bytes.
// :[0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]
#define RX_BUFFER_SIZE 2048 //EMH

#if RX_BUFFER_SIZE >= 1024
  // Enable to have the controller send XON/XOFF control characters to
  // the host to signal the RX buffer is becoming full.
  #define SERIAL_XON_XOFF //EMH
#endif
 ...
 */
#define ADVANCED_PAUSE_FEATURE //EMH
  ...
  #define PARK_HEAD_ON_PAUSE                      //EMH // Park the nozzle during pause and filament change.
 ...
 */
  ...
  #define HOLD_MULTIPLIER    0.6  //EMH Scales down the holding current from run current
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       1100       //EMH (2000Ma * 0.9)/1.414 => max 1272 (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME  X_CURRENT/2//EMH (mA) RMS current for homing. (Typically lower than *_CURRENT.)
    #define X_MICROSTEPS     32        //EMH 0..256
    ...
    #define Y_CURRENT       1100       //EMH (2000Ma * 0.9)/1.414 => max 1272
    #define Y_CURRENT_HOME  Y_CURRENT/2//EMH
    #define Y_MICROSTEPS     32        //EMH
    ...
    #define Z2_CURRENT      Z_CURRENT      //EMH
    #define Z2_CURRENT_HOME Z_CURRENT_HOME //EMH
    ...
    #define E0_CURRENT      565        //EMH (800Ma / 1.414)
    #define E0_MICROSTEPS   64         //EMH
    ...
    #define E1_CURRENT      100        //EMH not used, just to monitor the motor temp
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        //EMH All axes (override below)
   ...
   */
  #define MONITOR_DRIVER_STATUS  //EMH
  ...
  #define Z4_HYBRID_THRESHOLD      5 //EMH
  ...
  #define DIAG_JUMPERS_REMOVED //EMH => to suppress warning message

  #if ANY(SENSORLESS_HOMING, SENSORLESS_PROBING)
    // TMC2209: 0...255. TMC2130: -64...63
    #define X_STALL_SENSITIVITY  52                  //EMH
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY //EMH
    #define Y_STALL_SENSITIVITY  52                  //EMH
    #define Y2_STALL_SENSITIVITY Y_STALL_SENSITIVITY //EMH
    ...
    #define IMPROVE_HOMING_RELIABILITY  //EMH
  #endif
   ...
   */
  #define EDGE_STEPPING //EMH under test
 ...
 */
#define M114_DETAIL         //EMH // Use 'M114` for details to check planner calculations
#define M114_REALTIME       //EMH // Real current position based on forward kinematics
...
#define GCODE_CASE_INSENSITIVE    //EMH Accept G-code sent to the firmware in lowercase
 ...
 */
#define HOST_ACTION_COMMANDS              //EMH
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76                  //EMH Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT             //EMH Initiate host prompts to get user feedback
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS     //EMH Send some status messages to the host as notifications
  #endif
  #define HOST_START_MENU_ITEM            //EMH Add a menu item that tells the host to start
 ...
 */
//#define WIFISUPPORT         //EMH Marlin embedded WiFi management. Not needed for simple WiFi serial port.
