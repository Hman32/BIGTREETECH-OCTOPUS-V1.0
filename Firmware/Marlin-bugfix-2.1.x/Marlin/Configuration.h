...
#define STRING_CONFIG_H_AUTHOR "(BigTreeTech, Octopus)" //EMH
...
// Choose the name from boards.h that matches your setup
  ...
  #define MOTHERBOARD BOARD_BTT_OCTOPUS_PRO_V1_0_1 //EMH -> STM32H723 with USB
#endif
...
#define CUSTOM_MACHINE_NAME "VZBOT 330-A3" //EMH
...
#define TEMP_SENSOR_SOC 100 //EMH
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW  //EMH Set to HIGH for sensorless
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 20, 40 } //EMH
...
//#define BIQU_MICROPROBE_V2  //EMH // Triggers LOW
...
#define PROBING_MARGIN 2 //50 //EMH // Adjust this setting according to the PROBE OFFSET, account an extra 10mm from the offset
...
#define Z_CLEARANCE_FOR_HOMING   5  //EMH (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
...
#define Y_BED_SIZE 280 // 330 //EMH

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -3   //EMH
#define Y_MIN_POS -3    //EMH
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE+3 // EMH
#define Y_MAX_POS Y_BED_SIZE // EMH
...
#define Z_SAFE_HOMING //EMH
  ...
  #define Z_SAFE_HOMING_X_POINT 165 //X_CENTER  // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 165 //Y_CENTER  // (mm) Y point for Z homing
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2 //EMH
#define LCD_FEEDBACK_FREQUENCY_HZ 5000       //EMH
