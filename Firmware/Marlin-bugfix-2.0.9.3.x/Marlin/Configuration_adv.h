...
#define FAN_KICKSTART_TIME 100  //EMH
...
#define Z_STEPPER_AUTO_ALIGN //EMH
  ...
  #define Z_STEPPER_ALIGN_XY { {  50, 155 }, { 280,  155 } } //EMH
...
#define ASSISTED_TRAMMING  //EMH
  ...
  #define TRAMMING_POINT_XY { {  50, 50 }, { 165,  50 }, { 280,  50 }, { 280, 260 }, { 165, 260 }, { 50, 260 } }  //EMH
...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
  ...
  #define LCD_SET_PROGRESS_MANUALLY //EMH
...
// LCD Print Progress options
    ...
    #define SHOW_REMAINING_TIME           //EMH // Display estimated time to completion
      ...
      #define USE_M73_REMAINING_TIME      //EMH // Use remaining time from M73 command instead of estimation
      #define ROTATE_PROGRESS_DISPLAY     //EMH // Display (P)rogress, (E)lapsed, and (R)emaining time
    #endif
  #endif
